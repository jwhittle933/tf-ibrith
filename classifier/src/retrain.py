...
def main(_):
  ...
  with tf.Session(graph=graph) as sess:
    ...
    saver.save(sess, '%s/model.ckpt' % FLAGS.saved_model_dir)
    tf.train.write_graph(sess.graph.as_graph_def(), FLAGS.saved_model_dir, 'graph.pbtxt', as_text=True)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--tfhub_module',
      type=str,
      # uncomment for Inception as default
      # default=(
